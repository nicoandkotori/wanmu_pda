...
public class MaterialOutActivity extends FragmentActivity   {
    ...
    private List<ApplyOutDetail> mDatas;  //明细列表数据
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etWhName.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MaterialOutActivity.this, WarehouseSearch.class);
        ...
        etDepName.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MaterialOutActivity.this, DepartmentSearch.class);
                startActivityForResult(intent, 1);//
            }
        });
        ...
        etVouchDate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DatePickDialogUtil date=new DatePickDialogUtil(MaterialOutActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        mbtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(MaterialOutActivity.this);
...
//                    }
                    ...
                    if(sRow!=-1)
                    {
                        if(mDataBarcode!=null)
                        {
                            ...
                            if(barcode!=null)
                            {
                                ...
                                if(mDatas!=null)
                                {
                                    for(ApplyOutDetail dispatchLists:mDatas)
                                    {
        ...
        mbtnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(getBaseContext(),MaterialApplySelectActivity.class);
            ...
            case 11:
                ...
                if(CustomStringUtils.isNotBlank(strVouchId))
                {
                    ...
                    if(!strVouchId.equals("-1"))
                    {
                        ...
                        OkHttpUtils.postAsyn(StringUrl.GetUrl()+"/api/mo/applyout/getdetaillist",mapquery,new HttpCallback() {
                            @Override
                            public void onSuccess(ResultDesc resultDesc) {
                                super.onSuccess(resultDesc);
                                String res=resultDesc.getresult().toString();
                                mDatas= JSON.parseArray(res, ApplyOutDetail.class);
    ...
    //初始化条码列表数据
    private void  InitDates(List<ApplyOutDetail> list)
    {
        try
        {


            commonAdapter = new CommonAdapter<ApplyOutDetail>(this,list, R.layout.activity_material_out_item) {

                @Override
                protected void convertView(View item, ApplyOutDetail s) {
                                            ...
                                            if(mDatas!=null)
                                            {
                                                ...
                                                for(ApplyOutDetail dispatchLists:mDatas)
                                                {
                                                    ...
                                                    if(dispatchLists.getInvCode().equals(data.getInvCode()))
                                                    {
                                                        ...
                                                        data.setRecordId(dispatchLists.getMainId().toString());
                                                        data.setRecordsId(dispatchLists.getId().toString());
                                    ...
                                    if (list != null) {
                                        for(BarcodeProduct data:list) {
                                            ...
                                            if(mDatas!=null)
                                            {
                                                ...
                                                {
                                                    AlertDialog.Builder builder = new AlertDialog.Builder(MaterialOutActivity.this);
                                                    builder.setMessage("条码:"+data.getBarcode()+"不在申请单中！");
                                                    builder.setPositiveButton("确定", null);
                                                    builder.show();
                                                    return;
                                                }
