...
public class MoOrderSelectActivity extends FragmentActivity {
...
//    private Button mbtnAll;//全选
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mo_order_select);

        //标题
        titleView = (TitleView) findViewById(R.id.titleView);
        titleView.setAppTitle("订单批次查询");
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DatePickDialogUtil date=new DatePickDialogUtil(MoOrderSelectActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//        mbtnAll=(Button)findViewById(R.id.btnAll);
        ...
        mbtnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mDatas!=null&&sRow!=-1)
                {
                    ...
                    intent.putExtra("modId",orderInfo.getMoDetailId());
                    intent.putExtra("vouchCode",orderInfo.getVouchCode());
                    intent.putExtra("vouchDate", DateUtil.DateToStr(orderInfo.getVouchDate()));
                    intent.putExtra("invName",orderInfo.getInvName());
                    intent.putExtra("batchCode",orderInfo.getBatchCode());
                    intent.putExtra("planQty",orderInfo.getPlanQty().toString());
        ...
        mbtnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MoOrderInfo m=new MoOrderInfo();
                m.setVouchCode(etVouchCode.getText().toString());
                m.setBatchCode(etBatchCode.getText().toString());
                ...
                OkHttpUtils.postAsyn(StringUrl.GetUrl()+"/api/mo/order/getListForWeigh",mapquery,new HttpCallback() {
                    @Override
                    public void onSuccess(ResultDesc resultDesc) {
                        super.onSuccess(resultDesc);
                        String res=resultDesc.getresult().toString();
                        mDatas= JSON.parseArray(res,MoOrderInfo.class);
    ...
    //初始化列表数据
    private void  InitDates(List<MoOrderInfo> list)
    {

        try
        {
            commonAdapter = new CommonAdapter1<MoOrderInfo>(this,list, R.layout.activity_mo_order_select_item) {
    ...
    private void Close()
    {
        //关闭Activity
        Intent intent=new Intent();
        intent.putExtra("modId", "-1");
        intent.putExtra("vouchCode","");
        intent.putExtra("vouchDate", "");
        intent.putExtra("invName","");
        intent.putExtra("batchCode","");
        intent.putExtra("planQty","");
