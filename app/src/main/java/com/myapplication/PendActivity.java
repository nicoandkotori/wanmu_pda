...
public class PendActivity extends FragmentActivity {
        ...
        mbtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if(mDatas==null)
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(PendActivity.this);
                    ...
                    dialog.show();
                    OkHttpUtils.postAsyn(StringUrl.GetUrl() + "/api/mo/pend/save", mapquery, new HttpCallback() {
                        @Override
    ...
    private void  InitDates(List<BarcodeProduct> list)
    {
        ...
        try
        {
            commonAdapter = new CommonAdapter<BarcodeProduct>(this,list, R.layout.activity_pend_item) {
