...
public class TransSelectActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etStartDate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DatePickDialogUtil date=new DatePickDialogUtil(TransSelectActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        mbtnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mDatas!=null&&sRow!=-1)
                {
                    ...
                    intent.putExtra("sourceType","调拨单");
...
//                }
                ...
                OkHttpUtils.postAsyn(StringUrl.GetUrl()+"/api/st/transvouch/getlist",mapquery,new HttpCallback() {
                    @Override
