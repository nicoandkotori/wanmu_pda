...
public class UnBoxActivity extends FragmentActivity {
        ...
        mbtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if(mDatas==null)
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(UnBoxActivity.this);
                    ...
                    dialog.show();
                    OkHttpUtils.postAsyn(StringUrl.GetUrl() + "/api/st/boxmain/updatecanelbox", mapquery, new HttpCallback() {
                        @Override
    ...
    private void  InitDates(List<BarcodeProduct> list)
    {
        ...
        try
        {
            commonAdapter = new CommonAdapter<BarcodeProduct>(this,list, R.layout.activity_un_box_item) {
                        ...
                        if (resultDesc.getsuccess()) {
                            if (resultDesc.getresult() != null && resultDesc.getresult() != "null") {
                                ...
                                if (data != null) {
                                    ...
                                    if(data.getIzPack().equals("否"))
                                    {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(UnBoxActivity.this);
                                        builder.setMessage("请扫描已装箱条码");
                                        builder.setPositiveButton("确定", null);
                                        builder.show();
                                        return;
                                    }
